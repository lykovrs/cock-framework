...
import {toString, regExpEscape} from '@ng-bootstrap/ng-bootstrap/util/util';

@Component({
    selector: 'sc-highlight',
...
export class ScHighlightComponent implements OnChanges {
    parts: string[];

    @Input() highlightClass = 'sc-highlight';
    @Input() result: string;
    @Input() term: string;
